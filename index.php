<?php get_header(); ?>
        ...
        <div class="hero-box">
            ...
            <a href="#" class="btn btn-green hero-btn-2">Order Now!</a>
        </div>
        ...
        <div class="locations">
            ...
            <div id="pompton-lakes" class="title-red store-2">POMPTON LAKES</div>
    ...
    <div class="container">
            <div class="about-us-box">
                ...
                <a href="/donnas/about" class="btn btn-green about-us-box-button">Discover</a>
